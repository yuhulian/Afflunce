...
/**
  ...
  */
object SpendingPower2 {
  def main(args: Array[String]): Unit = {
    if (args.length != 5) {
      println("Wrong number of arguments!")
      println("Usage: <$PROVINCE> <$NUM_FEATURES> <$K> <$INPUT_DIR> <$RESULT_DIR>")
      System.exit(1)
    }
    val province = args(0)
    val numPCA = args(1).toInt
    val numClusters = args(2).toInt
    val inputDir = args(3)+"/"+province
    val resultDir = args(4)+"/"+province
    ...
    */
    ...
    val parsedData = trainData.map { line =>
      ...
      //val features = Vectors.dense(datacomsuption,arpu,deviceprice,outgoint_call_counter,localnumpoi,localnumdwells,roamnumpois,roamnumdwells,commutedistance,numuserlabels,homerealestateprice)
      val features = Vectors.dense(datacomsuption,arpu,deviceprice,localnumpoi,roamnumpois,commutedistance,numuserlabels,homerealestateprice)
...
//    })
    ...
    //parsedData.map(x=>(x._1,(x._2(0),x._2(1),x._2(2),x._2(3),x._2(4),x._2(5),x._2(6),x._2(7),x._2(8),x._2(9),x._2(10)))).zip(out).map(x=>x._1._1+"|"+x._1._2._1+"|"+x._1._2._2+"|"+x._1._2._3+"|"+x._1._2._4+"|"+x._1._2._5+"|"+x._1._2._6+"|"+x._1._2._7+"|"+x._1._2._8+"|"+x._1._2._9+"|"+x._1._2._10+"|"+x._1._2._11+"|"+x._2).coalesce(16).saveAsTextFile(resultDir)
    parsedData.map(x=>(x._1,(x._2(0),x._2(1),x._2(2),x._2(3),x._2(4),x._2(5),x._2(6),x._2(7)))).zip(out).map(x=>x._1._1+"|"+x._1._2._1+"|"+x._1._2._2+"|"+x._1._2._3+"|"+x._1._2._4+"|"+x._1._2._5+"|"+x._1._2._6+"|"+x._1._2._7+"|"+x._1._2._8+"|"+x._2).coalesce(16).saveAsTextFile(resultDir)
  }
}
